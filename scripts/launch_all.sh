...
echo "  watch -n 30 'find /Users/mac1/Projects/ghostofradio/sam-spade -name \"*.html\" | wc -l'"
echo ""
echo "Progress check: find /Users/mac1/Projects/ghostofradio/sam-spade -name '*.html' | wc -l"
